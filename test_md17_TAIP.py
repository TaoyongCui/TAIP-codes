...
rep = PaiNN(num_interactions=3, hidden_state_size=128, cutoff=6.0,pdb=False).to(device)
...
ckpt = torch.load('checkpoint/TAIP_MD17_aspirin.pt',map_location='cpu')        
...
test_dataset = dataset[split_idx['test']][0:1000]
...
optimizer = Adam(ssh.parameters(), lr=0.000001, weight_decay=0.0)
