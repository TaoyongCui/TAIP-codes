...
class EquivariantDenoisePred(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        mask_z,node_attr_label,masked_node_indices = self.mask(data.z.long().clone(),num_atom_type=self.model.out_decoder,mask_rate=0.15)
        ...
        # energy_pre2 = (energy_pre2 * 5.9468) + (-406737.2765)
