...
import sys
import glob
from baseline import MLCalculator_schnet
...
from TAIP_base import EquivariantDenoisePred
...
def printenergy(a=atoms):  # store a reference to atoms in the definition.
    ...
    global steps
    steps += intervals
    print(f"Steps={steps:8.0f} Epot={epot:8.2f} Ekin={ekin:8.2f} force_max={eforcemax:8.2f} force_mean={force_mean:8.2f} force_std={force_std:8.2f} temperature={temp:8.2f}\n")
...
traj = Trajectory(savedir+'/'+str(Temp)+'_base.traj', 'w', atoms)
