...
def notrain(net, batch_data, device):

    notrain_batch_data = batch_data.to(device)
    notrain_batch_data.cell =notrain_batch_data.cell.reshape(-1,3,3)


    e, f= updated_model(notrain_batch_data, net=net)
...
#        self.stress_scale = stress_scale
    ...
    def calculate(self, atoms=None, properties=["energy"], system_changes=all_changes):
        ...
        model_results = notrain(self.net,batch_data, 
                              self.device)
